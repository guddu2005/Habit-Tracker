        ...
        <div className='min-h-screen py-10' style={{ background: '#E9ECEF' }}>
            ...
            <Fade in={true} timeout={1000}>
                <form onSubmit={handleAdd} className='md:mx-20 mx-5 text-lg bg-white p-8 rounded-lg shadow-lg border border-gray-300'>
                    <p className='mt-3 mb-2 font-semibold text-gray-800'>Habit</p>
                    <input
                        className='md:w-96 w-11/12 h-10 border border-gray-400 text-sm p-2 rounded-md focus:ring-2 focus:ring-blue-500 focus:outline-none transition duration-200'
                        placeholder='Enter Habit'
                        type="text"
                        value={habit}
                        onChange={(e) => setHabit(e.target.value)}
                    ...
                    <p className='mt-4 mb-2 font-semibold text-gray-800'>Description</p>
                    <input
                        className='md:w-96 w-11/12  h-10 border border-gray-400 text-sm pr-3 pl-2 py-2 rounded-md focus:ring-2 focus:ring-blue-500 focus:outline-none transition duration-200'
                        placeholder='Enter Description'
                        type="text"
                        value={desc}
                        onChange={(e) => setDesc(e.target.value)}
